...
const systemInstructions = `
  ...
  Be colorful (but be mindful of color contrast/readbility). Feel free to choose colors based on individual phrases or even single words in the transcript.
